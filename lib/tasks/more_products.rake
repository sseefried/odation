...
task :more_products => :environment do
  ...
  base_url = "http://au.totaltravel.yahoo.com/directory/accommodation/australia/"
  ...
  while number_of_pages > i do  
    paginated_url = "http://au.totaltravel.yahoo.com/directory/accommodation/australia/#{i}/"
    ...
    results.each do |t|
      ...
      product = Product.new
      product.update_attribute(:title, title) 
      product.update_attribute(:description, scrapedurl) 
    end
    i = i + 1
